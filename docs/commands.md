...
soup train  # task='tts' + tts_family + modality='audio_out'  TTS pre-encoded codec-token SFT; Orpheus/Llasa live-codec; Spark/Oute raw-audio refused (upstream pins); Sesame CSM refused — LIVE (v0.71.20)
